...
class GfxUtilAccessFlagsTest : public testing::TestWithParam<GfxBackend> {
protected:
    void SetUp() override
    {
        backend = GetParam();
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutUndefined)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_UNDEFINED);
    EXPECT_EQ(flags, GFX_ACCESS_NONE);
}

TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutGeneral)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_GENERAL);
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutColorAttachment)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_COLOR_ATTACHMENT);
    if (backend == GFX_BACKEND_VULKAN) {
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutDepthStencil)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_DEPTH_STENCIL_ATTACHMENT);
    if (backend == GFX_BACKEND_VULKAN) {
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutDepthStencilReadOnly)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_DEPTH_STENCIL_READ_ONLY);
    if (backend == GFX_BACKEND_VULKAN) {
        EXPECT_EQ(flags, GFX_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ);
    } else {
        EXPECT_EQ(flags, GFX_ACCESS_NONE);
    }
}

TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutShaderReadOnly)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_SHADER_READ_ONLY);
    if (backend == GFX_BACKEND_VULKAN) {
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutTransferSrc)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_TRANSFER_SRC);
    if (backend == GFX_BACKEND_VULKAN) {
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutTransferDst)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_TRANSFER_DST);
    if (backend == GFX_BACKEND_VULKAN) {
...
TEST_P(GfxUtilAccessFlagsTest, GetAccessFlagsForLayoutPresent)
{
    GfxAccessFlags flags = gfxGetAccessFlagsForLayout(GFX_TEXTURE_LAYOUT_PRESENT_SRC);
    if (backend == GFX_BACKEND_VULKAN) {
